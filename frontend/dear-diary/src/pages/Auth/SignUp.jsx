  ...
  return (
    <div className='h-screen bg-cyan-50 overflow-hidden relative'>
      <div className='container h-screen flex items-center justify-center px-20 mx-auto'>
        <div className='w-2/6 h-[90vh] flex items-end bg-signup-bg-img bg-cover bg-center rounded-lg p-10 z-50'>
            <div>
        ...
        <div className='w-2/6 h-[75vh] bg-white rounded-r-lg relative p-16 shadow-lg shadow-cyan-200/20'>
          <form onSubmit={handleSignup}>
            ...
            <button type='submit' className='btn-primary transition duration-300'>CREATE ACCOUNT</button>

            <p className='text-xs text-slate-500 text-center my-4'>Or</p>

          </form>
            <button type='submit' className='btn-primary btn-light transition duration-300' onClick={() => navigate('/login')}>LOGIN</button>
        </div>
